...
function credentialFromResponse(
  ...
  switch (providerId) {
    case externs.ProviderId.GOOGLE:
      return impl.GoogleAuthProvider.credential(oauthIdToken, oauthAccessToken);
    case externs.ProviderId.FACEBOOK:
      return impl.FacebookAuthProvider.credential(oauthAccessToken!);
    case externs.ProviderId.GITHUB:
      return impl.GithubAuthProvider.credential(oauthAccessToken!);
    case externs.ProviderId.TWITTER:
      return impl.TwitterAuthProvider.credential(
        oauthAccessToken!,
        oauthTokenSecret!
      );
    default:
